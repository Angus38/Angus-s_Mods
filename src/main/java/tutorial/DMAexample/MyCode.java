...
import tutorial.DMAexample.MyItems.bronze_armour;
//OreGen
...
public class MyCode {
	...
	public static ArmorMaterial EnumArmorMaterialWhatever = EnumHelper.addArmorMaterial("BRONZE", 17, new int[]{3, 7, 5, 3}, 17);
	...
	public static void MyItems()
	{
		...
		.setUnlocalizedName("bronze_ingot");
		 ...
		 bronzePickaxe = new bronzePick(ToolMaterial.IRON)
			.setMaxStackSize(1)
		...
		//GameRegistry.registerItem(myCustomAxe, "CustomAxe");
		 ...
		 bronzeHelmet = new bronze_armour(MyCode.EnumArmorMaterialWhatever,5,0).setUnlocalizedName("bronze_helmet");
		 bronzeChestplate = new bronze_armour(MyCode.EnumArmorMaterialWhatever,5,1).setUnlocalizedName("bronze_chestplate");
		 bronzeLeggings = new bronze_armour(MyCode.EnumArmorMaterialWhatever,5,2).setUnlocalizedName("bronze_leggings");
		 bronzeBoots = new bronze_armour(MyCode.EnumArmorMaterialWhatever,5,3).setUnlocalizedName("bronze_boots");
